        ...
        <div className="flex items-center gap-6">
          ...
          <div className="relative">
            <div
              ...
              className="flex items-center gap-3 cursor-pointer bg-black/60 px-3 py-2 rounded-lg border border-blue-900"
            >
              <img
                src={user.profilePic}
            ...
            <AnimatePresence>
              {profileOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -15 }}
                  className="absolute right-0 mt-3 w-52 bg-black border border-gray-700 rounded-xl"
                >
{/* PROFILE BUTTON */}
        <motion.button
          whileHover={{
